...
public class GeneralStoreAppTest extends base {
	...
	static AndroidDriver<AndroidElement> driver;
		@Test
		public void homeScreenTest() throws IOException, InterruptedException {
		//service = startServer();
		driver = runCapabilities("GeneralStoreApp", true);
	 ...
	 * InterruptedException { Runtime.getRuntime().exec("taskkill /F /IM node.exe");
	 * Thread.sleep(4000); }
	 */
